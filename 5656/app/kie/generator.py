    ...
    async def generate(
        ...
        try:
            ...
            if not task_id:
                return {
                    'success': False,
                    'message': 'òÝÌ ¦Ý¦¦ TÃ¦+¦-¦¬¦-TÁTÌ TÁ¦-¦¬¦+¦-TÂTÌ ¦¬¦-¦+¦-TÇTÃ',
                    'result_urls': [],
                    'result_object': None,
            ...
            while True:
                ...
                if elapsed > timeout:
                    return {
                        'success': False,
                        'message': f'òÏ-ÿ¬Ï ¦ßTÀ¦¦¦-TËTÈ¦¦¦-¦- ¦-TÀ¦¦¦-TÏ ¦-¦¦¦¬¦+¦-¦-¦¬TÏ ({timeout} TÁ¦¦¦¦)',
                        'result_urls': [],
                        'result_object': None,
                        'error_code': 'TIMEOUT',
                ...
                if state == 'success':
                    ...
                    return {
                        'success': False,
                        'message': f"òÝÌ {error_msg}\n\n¦Ý¦-¦¦¦-¦¬TÂ¦¦ /start ¦+¦¬TÏ ¦-¦-¦¬¦-TÀ¦-TÂ¦- ¦- ¦-¦¦¦-TÎ.",
                        'result_urls': [],
                        'result_object': None,
                    ...
                    if time_since_heartbeat >= self._heartbeat_interval:
                        if progress_callback:
                            ...
                            progress_callback(
                                f"òÏ¦ ¦Þ¦-TÀ¦-¦-¦-TÂTË¦-¦-TÎ... (¦¬TÀ¦¬¦-¦¦TÀ¦-¦- {int(remaining)} TÁ¦¦¦¦ ¦-TÁTÂ¦-¦¬¦-TÁTÌ)\n"
                                f"¦ß¦-¦¦¦-¦¬TÃ¦¦TÁTÂ¦-, ¦¬¦-¦+¦-¦¦¦+¦¬TÂ¦¦."
                            )
                        last_heartbeat = datetime.now()
            ...
            return {
                'success': False,
                'message': f"òÝÌ ¦ÞTÈ¦¬¦-¦¦¦- ¦- ¦¬¦-TÀ¦-¦-¦¦TÂTÀ¦-TÅ: {str(e)}\n\n¦Ý¦-¦¦¦-¦¬TÂ¦¦ /start ¦+¦¬TÏ ¦-¦-¦¬¦-TÀ¦-TÂ¦- ¦- ¦-¦¦¦-TÎ.",
                'result_urls': [],
                'result_object': None,
