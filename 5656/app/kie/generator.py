        ...
        try:
            ...
            while True:
                ...
                if elapsed > timeout:
                    return {
                        'success': False,
                        'message': f'тП▒я╕П ╨Я╤А╨╡╨▓╤Л╤И╨╡╨╜╨╛ ╨▓╤А╨╡╨╝╤П ╨╛╨╢╨╕╨┤╨░╨╜╨╕╤П ({timeout} ╤Б╨╡╨║)',
                        'result_urls': [],
                        'result_object': None,
                        'error_code': 'TIMEOUT',
                ...
                if state == 'success':
                    ...
                    if time_since_heartbeat >= self._heartbeat_interval:
                        if progress_callback:
                            ...
                            progress_callback(
                                f"тП│ ╨Ю╨▒╤А╨░╨▒╨░╤В╤Л╨▓╨░╤О... (╨┐╤А╨╕╨╝╨╡╤А╨╜╨╛ {int(remaining)} ╤Б╨╡╨║ ╨╛╤Б╤В╨░╨╗╨╛╤Б╤М)\n"
                                f"╨Я╨╛╨╢╨░╨╗╤Г╨╣╤Б╤В╨░, ╨┐╨╛╨┤╨╛╨╢╨┤╨╕╤В╨╡."
                            )
                        last_heartbeat = datetime.now()
            ...
            return {
                'success': False,
                'message': f"тЭМ ╨Ю╤И╨╕╨▒╨║╨░ ╨▓ ╨┐╨░╤А╨░╨╝╨╡╤В╤А╨░╤Е: {str(e)}\n\n╨Э╨░╨╢╨╝╨╕╤В╨╡ /start ╨┤╨╗╤П ╨▓╨╛╨╖╨▓╤А╨░╤В╨░ ╨▓ ╨╝╨╡╨╜╤О.",
                'result_urls': [],
                'result_object': None,
